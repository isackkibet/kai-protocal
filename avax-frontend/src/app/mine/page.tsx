...
const ECOSYSTEM_REWARDS = [
  { symbol: 'NVR', name: 'Nuvari', reward: '10 NVR', color: '#e84142' },
  ...
  return (
    <main style={{ width: '100%', maxWidth: 1040, margin: '0 auto', padding: '24px 24px 110px', display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ paddingTop: 12, display: 'flex', alignItems: 'center', gap: 12 }}>
        <Link href="/" style={{ width: 36, height: 36, borderRadius: '50%', background: 'rgba(232,65,66,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', border: '1px solid rgba(232,65,66,0.3)' }}>
      ...
      <section className="airdrop-summary-grid" style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr 1fr', gap: 12 }}>
        <div className="glass" style={{ padding: 20, borderRadius: 20, background: 'linear-gradient(135deg, rgba(232,65,66,0.2), rgba(26,26,32,0.55))' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, color: '#e84142', fontSize: 11, fontWeight: 800, textTransform: 'uppercase', letterSpacing: 1 }}><Coins size={15} /> Ecosystem rewards</div>
      ...
      <div className="glass" style={{
        ...
        background: 'linear-gradient(135deg, rgba(232,65,66,0.1), rgba(10,10,12,0.6))',
        position: 'relative', overflow: 'hidden',
      }}>
        <div style={{ position: 'absolute', top: -20, right: -20, width: 80, height: 80, borderRadius: '50%', background: 'rgba(232,65,66,0.1)', filter: 'blur(20px)' }} />
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, marginBottom: 12 }}>
          <div>
            <span style={{ fontSize: 10, color: '#e84142', fontWeight: 800, textTransform: 'uppercase', letterSpacing: 1 }}>DAILY REWARD</span>
      ...
      <div className="glass" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          <div>
            <p style={{ fontSize: 13, fontWeight: 800, color: '#e84142', margin: 0 }}>🤖 Auto-Drop Agent</p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8 }}>
          {[
            { l: 'Mining Rate', v: '0.000 /s', c: '#e84142' },
            { l: 'Total Mined',  v: '0.0 NVR',   c: '#e84142' },
      ...
      <div className="glass" style={{ padding: 20, borderRadius: 20, border: '1px solid rgba(167,139,250,0.3)' }}>
        ...
        {!minted ? (
          ...
          <div style={{ textAlign: 'center', padding: '12px 0' }}>
            ...
            <p style={{ fontFamily: 'monospace', fontSize: 12, fontWeight: 700, color: '#e84142', margin: '4px 0 12px' }}>{minted}</p>
      ...
      <div>
        <p style={{ fontSize: 13, fontWeight: 700, color: 'rgba(255,255,255,0.7)', margin: '0 0 10px', display: 'flex', alignItems: 'center', gap: 6 }}>
          <UserPlus size={15} color="#e84142" /> Active Launchpools
        </p>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {WHITELIST.map((w, i) => (
            <div key={i} className="glass" style={{ padding: '14px 16px', borderRadius: 16, display: 'flex', alignItems: 'center', gap: 12 }}>
              <div style={{ width: 40, height: 40, borderRadius: 10, background: 'rgba(232,65,66,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18 }}>🎫</div>
              <div style={{ flex: 1 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: w.status === 'open' ? 'linear-gradient(135deg,#e84142,#7c1d1d)' : 'rgba(255,255,255,0.05)',
