  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100dvh', background: '#0a0a0c', fontFamily: 'inherit' }}>
      ...
      <div style={{
        ...
        background: 'rgba(10,10,12,0.95)', borderBottom: '1px solid rgba(232,65,66,0.18)',
        ...
        {/* Breadcrumb */}
        <div style={{ flex: 1 }}>
          <span style={{ fontSize: 11, color: '#e84142', fontWeight: 700 }}>KAI Web</span>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        {sidebarOpen && (
          <aside style={{
            ...
            borderRight: '1px solid rgba(232,65,66,0.12)', overflowY: 'auto',
            ...
            {PAGES.map(p => (
              <button
                ...
                style={{
                  ...
                  background: active.file === p.file ? 'rgba(232,65,66,0.15)' : 'transparent',
                  border: active.file === p.file ? '1px solid rgba(232,65,66,0.35)' : '1px solid transparent',
                  color: active.file === p.file ? '#e84142' : 'rgba(255,255,255,0.65)',
